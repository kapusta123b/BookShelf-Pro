document.addEventListener("DOMContentLoaded", function () {
  ...
  catalogSearchTypes.forEach(function (btn) {
    btn.addEventListener("click", function () {
      catalogSearchTypes.forEach(function (b) {
  ...
  filterCheckboxes.forEach(function (checkbox) {
    checkbox.addEventListener("change", function () {
      activeFiltersCount = document.querySelectorAll(
        '.filters input[type="checkbox"]:checked, .filters input[type="radio"]:not([value="all"]):checked',
      ).length;
