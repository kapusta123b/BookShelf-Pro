...
urlpatterns = [
    ...
    path('<slug:subject_slug>/<int:book_id>', views.BookDetailView.as_view(), name='book_detail'),
    path('<slug:subject_slug>/authors/<int:author_id>', views.AuthorDetailView.as_view(), name='author_detail'),
    path('<int:book_id>/create-review', views.CreateReviewView.as_view(), name='create_review'),
